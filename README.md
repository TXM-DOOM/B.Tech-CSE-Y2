# Welcome to Year II of our B.Tech(CSE) Program.

----------

## About this Repository
### Introduction
This repository was created with the intention of keeping track of all the files that the five contributors of this repository have in relation to the second year of the B.Tech(CSE) courses in the specialisations of AIML and CyberSec, as well as giving everyone the opportunity to polish their version control skills by using Git and GitHub on a daily basis.
